...
class PE_OptionHeader32 : public PE_OptionHeader
{
	friend class PE_NtHeader;
private:
	IMAGE_OPTIONAL_HEADER32	m_header;
protected:
	PE_OptionHeader32(IMAGE_OPTIONAL_HEADER32* pOptHdr = nullptr);
	virtual ~PE_OptionHeader32();
public:
